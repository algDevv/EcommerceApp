...
mongoose.connect(
"mongodb+srv://Rahim:Rahim17122002@ecommercedb.mcoawvo.mongodb.net/?retryWrites=true&w=majority&appName=EcommerceDB").then(() => console.log('MongoDB connected'))
...
app.post("/removeproduct", async (req, res) => {
  ...
  // update the cartItems of the user
  await User.updateMany(
    { "cartData": req.body.id },
    { $pull: { cartData: { id: req.body.id } } }
  );
  res.json({
    success: true,
    name: req.body.name,
